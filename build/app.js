...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Trigger = __webpack_require__(165);
	...
	_reactDom2.default.render(_react2.default.createElement(_Trigger2.default, null), document.querySelector('#app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tableData = __webpack_require__(166);

	var _tableData2 = _interopRequireDefault(_tableData);

	var _tableActions = __webpack_require__(170);
	    ...
	    _createClass(Trigger, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'container' },
	                _react2.default.createElement(_Table2.default, _extends({}, _tableData2.default, { cellValueChangeHandler: _tableActions.cellValueChangeHandler }))
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parser = function parser(shortcuts) {
	    var tableData = {
	        className: 'kb-sc',
	        tableHeaderRow: {
	            'module': new _cellValue2.default({ value: 'Module' }),
	            'action': new _cellValue2.default({ value: 'Action' }),
	            'command': new _cellValue2.default({ value: '' })
	        },

	        tableRows: Object.keys(shortcutConstants).reduce(function (result, module, i) {
	            var commandAction = shortcutConstants[module];

	            commandAction && (result['' + i] = Object.keys(commandAction).reduce(function (result, key, i) {
	                result.action['' + i] = new _cellValue2.default({ value: key });
	                result.command['' + i] = new _cellValue2.default({ value: commandAction[key], editable: true });
	                return result;
	            }, {
	                action: {},
	                command: {},
	...
	var tableData = parser(shortcutConstants);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	var Table = function Table(_ref) {
	    ...
	    var tableHeaderRow = _ref.tableHeaderRow;
	    var cellValueChangeHandler = _ref.cellValueChangeHandler;
	    var rowPosition = _ref.rowPosition;
	    return _react2.default.createElement(
	        'div',
	        { className: 'table table--' + className },
	        tableHeaderRow && _react2.default.createElement(
	            'div',
	            { className: 'table__header table__header--' + className },
	            _react2.default.createElement(_Row2.default, { className: 'row--header row--header__' + className,
	                key: 'row--header',
	                value: tableHeaderRow,
	                cellValueChangeHandler: cellValueChangeHandler })
	        ),
	        Object.keys(tableRows).map(function (key, i) {
	            return _react2.default.createElement(_Row2.default, { className: '' + key,
	                cellValueChangeHandler: cellValueChangeHandler,
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Row = function Row(_ref) {
	    ...
	    if (value instanceof _cellValue2.default) {
	        result = _react2.default.createElement(_Cell2.default, { rowPosition: rowPosition,
	            cellValueChangeHandler: cellValueChangeHandler,
	            className: className,
	            value: value });
	    } else {
	        result = Object.keys(value).map(function (key, i) {
	...
	var Cell = function (_Component) {
	    ...
	    _createClass(Cell, [{
	        ...
	        value: function handleBlur(event) {
	            ...
	            var rowPosition = _props.rowPosition;
	            var cellValueChangeHandler = _props.cellValueChangeHandler;
	            var key = _props.key;
	        ...
	        value: function render() {
	            ...
	            var key = _props2.key;
	            var cellValueChangeHandler = _props2.cellValueChangeHandler;
	            var rowPosition = _props2.rowPosition;
	            ...
	            if (value instanceof _cellValue2.default) {
	                ...
	                if (value.editable) {
	                    if (this.state.editMode) {
	                        ...
	                        return _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'i',
	                                { className: 'icon-edit', onClick: function onClick() {
	                                        _this2.setState({
	                                            editMode: true
	                                        });
	                                    } },
	                ...
	                return _react2.default.createElement(
	                    'div',
	                    { className: 'cell cell--table-wrapper cell--' + className },
	                    _react2.default.createElement(_Table2.default, { cellValueChangeHandler: cellValueChangeHandler,
	                        rowPosition: rowPosition,
	                        className: className,
	                        tableRows: value })
	                );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cellValueChangeHandler = function cellValueChangeHandler(_ref) {
	    var rowPosition = _ref.rowPosition;
	    var cellPosition = _ref.cellPosition;
	    var newValue = _ref.newValue;

	    var rowData = _tableData2.default.tableRows[rowPosition],
	        changeObject = void 0;
	    changeObject = _defineProperty({}, rowData.module.value + ' | ' + (rowData.action[cellPosition].value ? rowData.action[cellPosition].value : rowData.action[cellPosition]), newValue);
	    return changeObject;
	};

	var tableActions = { cellValueChangeHandler: cellValueChangeHandler };
...
/***/ function(module, exports) {
	...
	var CellValue = function CellValue(cellValue) {
	    _classCallCheck(this, CellValue);

	    Object.assign(this, cellValue);
	};
